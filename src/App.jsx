...
function Login() {
  ...
  return (
    <div style={{minHeight:"100vh",background:"#080C18",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'DM Sans',sans-serif"}}>
      ...
      <style>{`*{box-sizing:border-box;margin:0;padding:0}input::placeholder{color:#4B5563}select option{background:#1A2035}input::-ms-reveal,input::-ms-clear{display:none}input::-webkit-credentials-auto-fill-button{display:none}`}</style>
      <div style={{width:"100%",maxWidth:420,padding:20}}>
        ...
        <Card style={{padding:32}}>
          ...
          <div style={{position:"relative"}}>
            ...
            <button onClick={()=>setShowPass(s=>!s)} style={{position:"absolute",right:12,top:34,background:"none",border:"none",cursor:"pointer",color:"#6B7280",padding:0,display:"flex",alignItems:"center"}}>
              {showPass
