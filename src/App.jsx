...
function HistoriasClinicas({perfil}) {
  ...
  const exportarPDF = async () => {
    ...
    const addHeader = () => {
      ...
      // Logo
      try { doc.addImage(LOGO_B64, "JPEG", MARGIN, 2, 22, 22); } catch(e) {}
      // Titulo
      ...
      // Sede info
      const sedeNombre = pacSelec.sedes?.nombre || "";
      const sedeInfo = sedeNombre.toLowerCase().includes("molina")
        ? "Molisalud: Javier Prado 5998, La Molina  |  Tel: 987203017"
